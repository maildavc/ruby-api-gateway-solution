...
export default function LoginPage() {
  ...
  return (
    <AuthCard title="Welcome back" description="Sign in to manage keys, apps, and observability.">
      ...
      <div className="mt-6">
        <SecurityHint text="We use short-lived session tokens and rotate keys automatically on logout." />
      </div>
    </AuthCard>
  );
}
